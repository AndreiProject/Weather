...
import com.example.weather.days.screens.DaysWeatherViewModel.Companion.WEATHER_DAY_INFO
...
class DayTimeWeatherViewModel @Inject constructor(
    ...
    fun updateDayTimeWeatherState(townId: String, dayPos: Int) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            delay(1000)
            try {
                val weather = useCase.getWeather(townId, WEATHER_DAY_INFO * (dayPos + 1))
